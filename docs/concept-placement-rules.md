...
- **Keep it, flagged unverified** — ship it marked for manual correction.

The retirement cap of 25% is also unratified. For a 42-concept chapter it
permits ten concepts to disappear.
