...
from .canonical_source_phase221_metadata import (
    install as _install_canonical_source_phase221_metadata,
)
...
# adjudicates only unresolved original-document evidence; Phase 2.2.1 gives every
# selected original page an opaque evidence ID and caches verified decisions only.
...
_install_canonical_source_phase221_metadata()
...
del _install_canonical_source_phase221_metadata
