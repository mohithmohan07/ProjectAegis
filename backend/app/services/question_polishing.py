...
POLISH_SYSTEM = prompts.register(
    ...
    default=(
        ...
        "2b. An ask that only works as a classroom activity — read aloud, "
        "discuss in pairs, act out, ask your partner — cannot be handed to "
        "a learner on paper. Rephrase it as the nearest written-assessable "
        "form of the SAME ask (the same content, knowledge and difficulty; "
        "e.g. reading aloud for pronunciation becomes a written question "
        "on the same words), and say what changed in note. Never invent a "
        "different question.\n"
