...
def _plan_rules(rules_suffix: str) -> str:
    return (
        ...
        "recorded adaptive target for pre-learning coverage is 40 "
        "questions per concept, normally 20 Basic and 20 Intermediate. "
        "That figure is a target this project recorded, not an observed "
        "practice of any school, board or grade, and it is neither a "
        "mandatory quota nor a maximum; a thin pre-concept is never "
        "padded to reach 40, and a rich one is not capped at it. "
