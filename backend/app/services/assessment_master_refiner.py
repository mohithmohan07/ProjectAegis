...
CANDIDATE_SYSTEM = (
    ...
    "(pipe columns {|c|c|c|}, \\hline above and below every row, "
    "\\phantom{n} holding empty cells open, prose in \\text{...}, "
    "\\\\[0.12 cm] between a context sentence and the array — "
    "owner-corrected reference, 2026-08-29). For a multipart "
