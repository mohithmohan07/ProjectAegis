...
def test_prompt_preserves_source_faithful_short_prose_and_routing():
    ...
    assert "These dimensions are not a quota" in author
    assert "matching analytical concept before Culmination" in author
    assert "Chapter-wide scope alone" in critic
