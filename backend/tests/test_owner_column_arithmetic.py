...
def _candidate(scoring: str, large_weight: str = "1E+50") -> dict:
    ...
    # Exercise variable arithmetic with an approved category that declares
    # no fixed mark total, independently of the source fixture's four marks.
    candidate["question_category"] = "Numerical/application based"
